...
Public Class crp_IN_DIEMMH
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "QLSV_VB.crp_IN_DIEMMH.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_MONHOC() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedcrp_IN_DIEMMH
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crp_IN_DIEMMH = New crp_IN_DIEMMH()
        rpt.Site = Me.Site
        Return rpt
    End Function
